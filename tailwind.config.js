  ...
  theme: {
    extend: {
      colors: {
        ...
        // Titan color palette from hero image
        titan: {
          background: '#1A103B', // Deep Space Purple
          purple: '#7B2FF2',     // Vivid Purple
          blue: '#1A5AFF',       // Electric Blue
          orange: '#FF8C3B',     // Sunset Orange
          yellow: '#FFD86B',     // Bright Yellow
