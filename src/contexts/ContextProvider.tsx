...
const WalletContextProvider: React.FC<PropsWithChildren<IInit>> = ({
  ...
  const enableWalletPassthrough = (() => {
    ...
    return window.Titan.enableWalletPassthrough;
  })();
          ...
          <UnifiedWalletProvider
            ...
            config={{
              ...
              metadata: {
                ...
                description:
                  'An open-sourced, lite version of Titan that provides end-to-end swap flow by linking it in your HTML. Check out the visual demo for the various integration modes below.          ',
                iconUrls: [],
              },
              hardcodedWallets: [],
              walletPrecedence: [],
